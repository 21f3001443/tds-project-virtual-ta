...
Post 1: sir I am not able to solve these question I have tried all thing also the video which you shared but still after using postman also i am unable to answer it (showing methods not allowed everytime)and also in Q8 I am having this problem Screenshot 2025-02-05 182750 1917×1018 38.3 KB import requests
...
![The image shows a screenshot of a web page displaying an error message. The URL in the browser indicates a query being executed on a local server (`127.0.0.1:8000`). The error message is in JSON format, indicating a missing field in the query. The details specify that the type of error is "missing," with the location being the "query" parameter "q." The message states "Field required," and the input is `null`.](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/d/7/d7e9677b9a8d204c98e6008ef57a884177301fad_2_690x366.png)
[View on Discourse](https://discourse.onlinedegree.iitm.ac.in/t/doubts-in-q7-q8/166357/1)
